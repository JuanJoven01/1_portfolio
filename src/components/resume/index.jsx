const Resume = () => {
    return(
        <section className="flex px-20 flex-wrap justify-center items-center">
            <img src="../../../public/img/jp.jpeg" className=" w-1/4  m-5 h-fit" />
            <div className="rounded-xl bg-gradient-to-r from-blue-500 to-charlie flex p-0.5 m-10 max-w-xl ">
                <p className="self-center text-slate-300 font-satoshi-italic text-justify text-lg bg-slate-800 p-10 rounded-xl h-full w-full"  >
